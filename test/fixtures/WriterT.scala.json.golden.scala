package scalaz {
  ...
  final case class WriterT[W, F[_], A] (run : F[(W, A)]) { self =>
    ...
    def unary_- : UnwriterT[F, W, A] =
      UnwriterT(run)
    def mapValue[X, B]( f : ((W, A)) => ( X
    , B ) )(implicit F : Functor[F]) : WriterT[X, F, B] =
      writerT(F.map(run)(f))
    ...
    def flatMap[B](f : (A) => WriterT[W, F, B])( implicit F : Bind[F]
    ...
    , g : (A) => G[D] )( implicit G : Applicative[G]
    , F : Traverse[F] ) : G[WriterT[C, F, D]] =
      G.map( F.traverse[G, (W, A), (C, D)](run)( {
        case (a, b) =>
          G.tuple2(f(a), g(b))
      } ) )(writerT(_))
    def rwst[R, S](implicit F : Functor[F]) : ReaderWriterStateT[ R
    , W
    , S
    , F
    , A ] =
  ...
  sealed abstract class WriterTInstances16  {
    implicit def writerTDivisible[ F[_]
    , W
    , A ](implicit F0 : Divisible[F]) : Divisible[WriterT[W, F, *]] =
  ...
  sealed abstract class WriterTInstances15  extends WriterTInstances16 {
    implicit def writerTMonoid[W, F[_], A]( implicit M : Monoid[ F[ ( W
    , A ) ] ] ) : Monoid[WriterT[W, F, A]] =
      new Monoid[WriterT[W, F, A]] {
        def zero =
          WriterT(M.zero)
        def append(a : WriterT[W, F, A], b : => WriterT[W, F, A]) =
          WriterT(M.append(a.run, b.run))
      }
    implicit def writerTPlus[W, F[_]](implicit F0 : Plus[F]) : Plus[ WriterT[ W
    , F
    , * ] ] =
      new WriterTPlus[F, W] {
        def F =
    ...
    implicit def writerTDecidable[ F[_]
    , W
    , A ](implicit F0 : Decidable[F]) : Decidable[WriterT[W, F, *]] =
  ...
  sealed abstract class WriterTInstances14  extends WriterTInstances15 {
    ...
    implicit def writerTPlusEmpty[ W
    , F[_] ](implicit F0 : PlusEmpty[F]) : PlusEmpty[WriterT[W, F, *]] =
  ...
  sealed abstract class WriterTInstances13  extends WriterTInstances14 {
    implicit def writerTFunctor[ W
    , F[_] ](implicit F0 : Functor[F]) : Functor[WriterT[W, F, *]] =
  ...
  sealed abstract class WriterTInstances11  extends WriterTInstances12 {
    implicit def writerTBindRec[W, F[_]]( implicit W0 : Semigroup[W]
    , F0 : BindRec[F]
    , F1 : Applicative[F] ) : BindRec[WriterT[W, F, *]] =
  ...
  sealed abstract class WriterTInstances10  extends WriterTInstances11 {
    implicit def writerTApply[W, F[_]]( implicit W0 : Semigroup[W]
    , F0 : Apply[F] ) : Apply[WriterT[W, F, *]] =
  ...
  sealed abstract class WriterTInstances9  extends WriterTInstances10 {
    implicit def writerTBind[W, F[_]]( implicit W0 : Semigroup[W]
    , F0 : Bind[F] ) : Bind[WriterT[W, F, *]] =
      new WriterTBind[F, W] {
        implicit def F =
          F0
        implicit def W =
  ...
  sealed abstract class WriterTInstances8  extends WriterTInstances9 {
    implicit def writerTApplicative[W, F[_]]( implicit W0 : Monoid[W]
    , F0 : Applicative[F] ) : Applicative[WriterT[W, F, *]] =
  ...
  sealed abstract class WriterTInstance5  extends WriterTInstances6 {
    implicit def writerTMonad[W, F[_]]( implicit W0 : Monoid[W]
    , F0 : Monad[F] ) : Monad[WriterT[W, F, *]] =
  ...
  sealed abstract class WriterTInstances3  extends WriterTInstances4 {
    implicit def writerTBifunctor[ F[ _ ] ]( implicit F0 : Functor[ F ] ) : Bifunctor[ WriterT[ *
    , F
    , * ] ] =
    ...
    implicit def writerTFoldable[ W
    , F[_] ](implicit F0 : Foldable[F]) : Foldable[WriterT[W, F, *]] =
  ...
  sealed abstract class WriterTInstances1  extends WriterTInstances2 {
    ...
    implicit def writerTTraverse[ W
    , F[_] ](implicit F0 : Traverse[F]) : Traverse[WriterT[W, F, *]] =
  ...
  sealed abstract class WriterTInstances0  extends WriterTInstances1 {
    implicit def writerTBitraverse[ F[ _ ] ]( implicit F0 : Traverse[ F ] ) : Bitraverse[ WriterT[ *
    , F
    , * ] ] =
  ...
  sealed abstract class WriterTInstances  extends WriterTInstances0 {
    implicit def writerTMonadListen[W, F[_]]( implicit F0 : Monad[F]
    , W0 : Monoid[W] ) : MonadListen[WriterT[W, F, *], W] =
    ...
    implicit def writerTHoist[ W ]( implicit W0 : Monoid[ W ] ) : Hoist[ ( {type l[ α[ _ ]
    , β ] = WriterT[W, α, β]})#l ] =
      new WriterTHoist[W] {
        implicit def W =
          W0
      }
    implicit def writerTShow[F[_], W, A]( implicit F0 : Show[ F[ ( W
    , A ) ] ] ) : Show[WriterT[W, F, A]] =
  ...
  trait WriterTFunctions  {
    def writerT[F[_], W, A](v : F[(W, A)]) : WriterT[W, F, A] =
      WriterT(v)
    def writerTU[FAB, AB, A0, B0](fab : FAB)( implicit u1 : Unapply[ Functor
    , FAB ] {type A = AB}
  ...
  private trait WriterTDivisible[F[_], W]  extends Divisible[WriterT[W, F, *]] {
    implicit def F: Divisible[F]
    override def conquer[Z] : WriterT[W, F, Z] =
      WriterT(F.conquer)
  ...
  private trait WriterTPlusEmpty[F[_], W]  extends PlusEmpty[WriterT[W, F, *]]
  ...
  , * ] ]
   with WriterTApply[F, W] {
    ...
    def point[A](a : => A) =
      writerT(F.point((W.zero, a)))
  }

  private trait WriterTBind[F[_], W]  extends Bind[WriterT[W, F, *]]
   with WriterTApply[F, W] {
  ...
  private trait WriterTMonad[F[_], W]  extends Monad[WriterT[W, F, *]]
   with WriterTApplicative[F, W]
   with WriterTBind[F, W] {
    implicit def F: Monad[F]
  }

  private trait WriterTMonadPlus[F[_], W]  extends MonadPlus[WriterT[W, F, *]]
   with WriterTMonad[F, W]
   with WriterTPlusEmpty[F, W] {
    def F: MonadPlus[F]
  }

  private trait WriterTMonadError[F[_], E, W]  extends MonadError[ WriterT[ W
  , F
  , * ]
  , E ]
   with WriterTMonad[F, W] {
    implicit def F: MonadError[F, E]
    override def handleError[A](fa : WriterT[W, F, A])( f : (E) => WriterT[ W
    , F
    , A ] ) =
  ...
  private trait WriterTFoldable[F[_], W]  extends Foldable.FromFoldr[ WriterT[ W
  , F
  , * ] ] {
    implicit def F: Foldable[F]
    override def foldRight[A, B](fa : WriterT[W, F, A], z : => B)( f : ( A
    , => B ) => B ) =
      fa.foldRight(z)(f)
  }

  private trait WriterTTraverse[F[_], W]  extends Traverse[WriterT[W, F, *]]
  ...
  private trait WriterTBifunctor[F[_]]  extends Bifunctor[WriterT[*, F, *]] {
    implicit def F: Functor[F]
    override def bimap[A, B, C, D](fab : WriterT[A, F, B])( f : (A) => C
    , g : (B) => D ) =
      fab.bimap(f, g)
  }

  private trait WriterTBitraverse[F[_]]  extends Bitraverse[WriterT[*, F, *]]
   with WriterTBifunctor[F] {
    implicit def F: Traverse[F]
    def bitraverseImpl[G[_]: Applicative, A, B, C, D]( fab : WriterT[ A
    , F
    , B ] )(f : (A) => G[C], g : (B) => G[D]) =
      fab.bitraverse(f, g)
  }

  private trait WriterComonad[W]  extends Comonad[Writer[W, *]]
   with WriterTFunctor[Id, W] {
    def copoint[A](p : Writer[W, A]) : A =
      p.value
    override def cojoin[A](fa : Writer[W, A]) : Writer[W, Writer[W, A]] =
      Writer(fa.written, fa)
    override def cobind[A, B](fa : Writer[W, A])( f : ( Writer[ W
    , A ] ) => B ) : Writer[W, B] =
      Writer(fa.written, f(fa))
  }

  private trait WriterTHoist[W]  extends Hoist[ ( {type l[α[_], β] = WriterT[ W
  , α
  , β ]})#l ] {
  ...
  private trait WriterTMonadListen[F[_], W]  extends MonadListen[ WriterT[ W
  , F
  , * ]
  , W ]
   with WriterTMonad[F, W] {
