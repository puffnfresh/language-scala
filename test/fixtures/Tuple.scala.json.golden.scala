package scalaz {
  package std {
    ...
    sealed trait TupleInstances2  extends TupleInstances1 {
      ...
      implicit def tuple5Equal[A1, A2, A3, A4, A5](implicit A1: Equal[A1], A2: Equal[A2], A3: Equal[A3], A4: Equal[A4], A5: Equal[A5]): Equal[ ( A1
      , A2
      , A3
      , A4
      , A5 ) ] =
    ...
    sealed trait TupleInstances3  extends TupleInstances2 {
      ...
      implicit def tuple5Order[A1, A2, A3, A4, A5](implicit A1: Order[A1], A2: Order[A2], A3: Order[A3], A4: Order[A4], A5: Order[A5]): Order[ ( A1
      , A2
      , A3
      , A4
      , A5 ) ] =
    ...
    private trait Tuple8Order[A1, A2, A3, A4, A5, A6, A7, A8]  extends Order[(A1, A2, A3, A4, A5, A6, A7, A8)] with Tuple8Equal[ A1
    , A2
    , A3
    , A4
    , A5
    ...
    private trait Tuple7Monoid[A1, A2, A3, A4, A5, A6, A7]  extends Monoid[(A1, A2, A3, A4, A5, A6, A7)] with Tuple7Semigroup[ A1
    , A2
    , A3
    , A4
    , A5
    ...
    private trait Tuple8Monoid[A1, A2, A3, A4, A5, A6, A7, A8]  extends Monoid[(A1, A2, A3, A4, A5, A6, A7, A8)] with Tuple8Semigroup[ A1
    , A2
    , A3
    , A4
    , A5
