package scalaz {
  package std {
    ...
    trait FunctionInstances  extends FunctionInstances0 {
      ...
      implicit def function7Instance[T1, T2, T3, T4, T5, T6, T7]: Monad[(T1, T2, T3, T4, T5, T6, T7) => *] with BindRec[ ( T1
      , T2
      , T3
      , T4
      , T5
      ...
      implicit def function8Instance[T1, T2, T3, T4, T5, T6, T7, T8]: Monad[(T1, T2, T3, T4, T5, T6, T7, T8) => *] with BindRec[ ( T1
      , T2
      , T3
      , T4
      , T5
