package scalaz {
  package std {
    ...
    sealed trait FunctionInstances1  {
      implicit def function1Semigroup[ A
      , R ](implicit R0 : Semigroup[R]) : Semigroup[(A) => R] =
        new Function1Semigroup[A, R] {
          implicit def R =
            R0
        }
      implicit def function1Cobind[ A
      , R ](implicit A0 : Semigroup[A]) : Cobind[(A) => *] =
    ...
    sealed trait FunctionInstances0  extends FunctionInstances1 {
      implicit def function1Monoid[ A
      , R ](implicit R0 : Monoid[R]) : Monoid[(A) => R] =
        new Function1Monoid[A, R] {
          implicit def R =
            R0
        }
      implicit def function1Comonad[ A
      , R ](implicit A0 : Monoid[A]) : Comonad[(A) => *] =
    ...
    trait FunctionInstances  extends FunctionInstances0 {
      ...
      implicit val function1Instance : Arrow[ Function1 ] with Choice[ Function1 ] with ProChoice[ Function1 ] =
        new Arrow[Function1] with Choice[Function1] with ProChoice[Function1] {
          def left[A, B, C](fa : (A) => B) =
            _.leftMap(fa)
          def right[A, B, C](fa : (A) => B) =
            _.map(fa)
          def arr[A, B](f : (A) => B) =
            f
          ...
          override def split[A, B, C, D](f : (A) => B, g : (C) => D) : ( ( A
          , C ) ) => (B, D) =
            {
              case (a, c) =>
                (f(a), g(c))
      ...
      , T3
      , T4
      , T5 ) => * ] with BindRec[(T1, T2, T3, T4, T5) => *] =
      ...
      , T4
      , T5
      , T6 ) => * ] with BindRec[(T1, T2, T3, T4, T5, T6) => *] =
      ...
      , T5
      , T6
      , T7 ) => * ] with BindRec[(T1, T2, T3, T4, T5, T6, T7) => *] =
      ...
      , T6
      , T7
      , T8 ] : Monad[(T1, T2, T3, T4, T5, T6, T7, T8) => *] with BindRec[ ( T1
      , T2
      , T3
      , T4
      , T5
