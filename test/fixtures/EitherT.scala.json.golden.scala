package scalaz {
  ...
  object EitherT extends EitherTInstances {
    ...
    def eitherTU[FAB, AB, A0, B0](fab : FAB)( implicit u1 : Unapply[ Functor
    , FAB ] {type A = AB}
    ...
    def monadListen[F[_], W, A]( implicit ML0 : MonadListen[ F
    , W ] ) : EitherTMonadListen[F, W, A] =
    ...
    private[scalaz] final class EitherTLeft[ B ] ( private val dummy : Boolean ) extends AnyVal {
      def apply[FA](fa : FA)(implicit F : Unapply[Functor, FA]) : EitherT[ F.A
      , F.M
      , B ] =
        leftT[F.A, F.M, B](F(fa))(F.TC)
    }
    private[scalaz] final class EitherTRight[ A ] ( private val dummy : Boolean ) extends AnyVal {
      def apply[FB](fb : FB)(implicit F : Unapply[Functor, FB]) : EitherT[ A
      , F.M
      , F.A ] =
        rightT[A, F.M, F.A](F(fb))(F.TC)
    }
    def fromEither[F[_], A, B]( e : F[ Either[ A
    , B ] ] )(implicit F : Functor[F]) : EitherT[A, F, B] =
  ...
  sealed abstract class EitherTInstances5  {
    implicit def eitherTNondeterminism[ F[_]
    , E ](implicit F0 : Nondeterminism[F]) : Nondeterminism[EitherT[E, F, *]] =
  ...
  sealed abstract class EitherTInstances4  extends EitherTInstances5 {
    implicit def eitherTBindRec[F[_], E]( implicit F0 : Monad[F]
    , B0 : BindRec[F] ) : BindRec[EitherT[E, F, *]] =
  ...
  sealed abstract class EitherTInstances3  extends EitherTInstances4 {
    implicit def eitherTFunctor[ F[_]
    , L ](implicit F0 : Functor[F]) : Functor[EitherT[L, F, *]] =
  ...
  sealed abstract class EitherTInstances2  extends EitherTInstances3 {
    ...
    , E ](implicit F0 : Monad[F]) : MonadError[EitherT[E, F, *], E] =
  ...
  sealed abstract class EitherTInstances1  extends EitherTInstances2 {
    ...
    , L0 : Semigroup[L] ) : Plus[EitherT[L, F, *]] =
      new EitherTPlus[F, L] {
        implicit def F =
          F0
        implicit def G =
    ...
    implicit def eitherTMonadReader[E, F[_], R]( implicit F0 : MonadReader[ F
    , R ] ) : MonadReader[EitherT[E, F, *], R] =
  ...
  sealed abstract class EitherTInstances0  extends EitherTInstances1 {
    implicit def eitherTBifunctor[ F[ _ ] ]( implicit F0 : Functor[ F ] ) : Bifunctor[ EitherT[ *
    , F
    , * ] ] =
    ...
    implicit def eitherTBifoldable[ F[ _ ] ]( implicit F0 : Foldable[ F ] ) : Bifoldable[ EitherT[ *
    , F
    , * ] ] =
    ...
    implicit def eitherTMonadPlusAlt[F[_], L]( implicit F0 : Monad[F]
    , L0 : Monoid[L] ) : MonadPlus[EitherT[L, F, *]] with Alt[ EitherT[ L
    , F
    , * ] ] =
      new EitherTMonadPlus[F, L] with Alt[EitherT[L, F, *]] {
        ...
        implicit def G =
          L0
        def alt[A]( a1 : => EitherT[L, F, A]
        , a2 : => EitherT[L, F, A] ) : EitherT[L, F, A] =
          EitherT( F.bind(a1.run)( {
            case -\/ (l) =>
              F.map(a2.run)(_.leftMap(G.append(l, _)))
            case r: \/-[L, A] =>
              F.point(r)
          } ) )
      }
    implicit def eitherTFoldable[ F[_]
    , L ](implicit F0 : Foldable[F]) : Foldable[EitherT[L, F, *]] =
  ...
  sealed abstract class EitherTInstances  extends EitherTInstances0 {
    implicit def eitherTBitraverse[ F[ _ ] ]( implicit F0 : Traverse[ F ] ) : Bitraverse[ EitherT[ *
    , F
    , * ] ] =
    ...
    implicit def eitherTTraverse[ F[_]
    , L ](implicit F0 : Traverse[F]) : Traverse[EitherT[L, F, *]] =
      new EitherTTraverse[F, L] {
        implicit def F =
          F0
      }
    implicit def eitherTHoist[A] : Hoist[ ( {type l[α[_], β] = EitherT[ A
    , α
    , β ]})#l ] =
      new EitherTHoist[A] {
      }
  ...
  private trait EitherTPlus[F[_], E]  extends Plus[EitherT[E, F, *]] {
    def F: Monad[F]
    def G: Semigroup[E]
    def plus[A](a : EitherT[E, F, A], b : => EitherT[E, F, A]) : EitherT[ E
    , F
    , A ] =
  ...
  private trait EitherTMonadPlus[F[_], E]  extends MonadPlus[EitherT[E, F, *]]
   with EitherTMonad[F, E]
   with EitherTPlus[F, E] {
    def G: Monoid[E]
    def empty[A] : EitherT[E, F, A] =
      EitherT(F.point(-\/(G.zero)))
  }

  private trait EitherTFoldable[F[_], E]  extends Foldable.FromFoldr[ EitherT[ E
  , F
  , * ] ] {
    implicit def F: Foldable[F]
    override def foldRight[A, B](fa : EitherT[E, F, A], z : => B)( f : ( A
    , => B ) => B ) : B =
      fa.foldRight(z)(f)
  }

  private trait EitherTTraverse[F[_], E]  extends Traverse[EitherT[E, F, *]]
   with EitherTFoldable[F, E] {
  ...
  private trait EitherTBifunctor[F[_]]  extends Bifunctor[EitherT[*, F, *]] {
    implicit def F: Functor[F]
    override def bimap[A, B, C, D](fab : EitherT[A, F, B])( f : (A) => C
    , g : (B) => D ) : EitherT[C, F, D] =
      fab.bimap(f, g)
  }

  private trait EitherTBifoldable[ F[ _ ] ]  extends Bifoldable.FromBifoldMap[ EitherT[ *
  , F
  , * ] ] {
    implicit def F: Foldable[F]
    override final def bifoldMap[A, B, M: Monoid]( fab : EitherT[ A
    , F
    , B ] )(f : (A) => M)(g : (B) => M) =
      F.foldMap(fab.run)(Bifoldable[\/].bifoldMap(_)(f)(g))
  }

  private trait EitherTBitraverse[F[_]]  extends Bitraverse[EitherT[*, F, *]]
   with EitherTBifunctor[F]
   with EitherTBifoldable[F] {
    implicit def F: Traverse[F]
    def bitraverseImpl[G[_]: Applicative, A, B, C, D]( fab : EitherT[ A
    , F
    , B ] )(f : (A) => G[C], g : (B) => G[D]) : G[EitherT[C, F, D]] =
      fab.bitraverse(f, g)
  }
  ...
  , β ]})#l ] {
    ...
    def liftM[M[_], B](mb : M[B])(implicit M : Monad[M]) : EitherT[A, M, B] =
      EitherT(M.map(mb)(\/.right))
    implicit def apply[M[_]: Monad] : Monad[EitherT[A, M, *]] =
      EitherT.eitherTMonadError
  }

  private[scalaz] trait EitherTMonadTell[ F[_]
  , W
  , A ]  extends MonadTell[EitherT[A, F, *], W]
   with EitherTMonad[F, A]
   with EitherTHoist[A] {
  ...
  private[scalaz] trait EitherTMonadListen[ F[_]
  , W
  , A ]  extends MonadListen[EitherT[A, F, *], W]
   with EitherTMonadTell[F, W, A] {
  ...
  private trait EitherTMonadError[F[_], E]  extends MonadError[ EitherT[E, F, *]
  , E ]
   with EitherTMonad[F, E] {
    implicit def F: Monad[F]
    def raiseError[A](e : E) : EitherT[E, F, A] =
      EitherT(F.point(-\/(e)))
    def handleError[A](fa : EitherT[E, F, A])( f : (E) => EitherT[ E
    , F
    , A ] ) : EitherT[E, F, A] =
  ...
  private trait EitherTNondeterminism[ F[_]
  , E ]  extends Nondeterminism[EitherT[E, F, *]] with EitherTMonad[F, E] {
    implicit def F: Nondeterminism[F]
    def chooseAny[A]( head : EitherT[E, F, A]
  ...
  private trait EitherTMonadReader[E, F[_], R]  extends MonadReader[ EitherT[ E
  , F
  , * ]
  , R ]
   with EitherTMonad[F, E] {
